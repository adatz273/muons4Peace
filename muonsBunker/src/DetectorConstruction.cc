...
namespace muonsBunker {
  ...
  // --------------------- visualize Eco Mug half sphere of muon generation ------------------------------------------//
  //(only for visualization, do not use during actual simulations)
  ...
  //--------------------------------------------------------------------------------------------------------------------//
    ...
    // write detector details to property tree
    ...
    // write fissile mat details to property tree
    if(use_fM){
    ...
    // return pointer to the master physical volume
    return physWorld;
  }
